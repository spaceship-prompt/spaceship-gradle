...
oneTimeSetUp() {
  ...
  source "$(dirname $CWD)/spaceship-gradle.plugin.zsh"

  SPACESHIP_PROMPT_ASYNC=false
  SPACESHIP_PROMPT_FIRST_PREFIX_SHOW=true
  SPACESHIP_PROMPT_ADD_NEWLINE=false
  SPACESHIP_PROMPT_ORDER=(gradle)
...
test_defined() {
  assertTrue 'should define spaceship_gradle' "spaceship::exists spaceship_gradle"
}
